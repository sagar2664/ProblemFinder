...
matrix_path = os.path.join(BASE_DIR, 'data/leetcode/matrix.pkl')
vectorizer_path = os.path.join(BASE_DIR, 'data/leetcode/vectorizer.pkl')
headings_path = os.path.join(BASE_DIR, 'data/leetcode/headings.txt')
problem_links_path = os.path.join(BASE_DIR, 'data/leetcode/urls.txt')
